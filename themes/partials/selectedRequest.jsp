<%--
 $Rev: 103 $
 $Date: 2010-09-29 15:54:43 -0500 (Wed, 29 Sep 2010) $
--%>
...
<div class="selReq">
    <div class="selReqDetails">
        <div class="head rounded6">
            <div>
                <div class="left"><b><%= baseEntry.getEntryFieldValue(constants.get("TemplateName"))%></b></div>
        ...
        <div class="detail rounded6">
			<div class="body">
		       	<div><div class="label">Requested&nbsp;At:</div> <div class="value"><%= dateFormat.format(createdAtDate) %></div></div>  
				<div><div class="label">Status: </div> <div class="value"><%=baseEntry.getEntryFieldValue(constants.get("ValidationStatus"))%></div></div>
				...
				<div><div class="label">Notes: </div><div class="value"><%= baseEntry.getEntryFieldValue(constants.get("NotesForCustomer"))%></div></div>
				<%}%>
			</div>
					...
					<div class="task <%=taskEntry.getEntryFieldValue(constants.get("TaskStatus")) %> ">
						...
						<div class="body">
							<div class="content">
								...
								<div><div class="label">Status: </div><div class="value"><%= taskEntry.getEntryFieldValue(constants.get("TaskStatus"))%></div></div>
								...
								<div><div class="label">Approver: </div><div class="value"><%= taskEntry.getEntryFieldValue(constants.get("ApproverFirstName"))%> <%= taskEntry.getEntryFieldValue(constants.get("ApproverLastName"))%> </div></div>
								<%}%>
							</div>
